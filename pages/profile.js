...
function ProfilePage() {
  ...
  const tabClasses =
    "flex gap-1 items-center px-4 py-1 border-b-4 border-transparent";
  const activeTabClasses =
    "flex gap-1 items-center px-4 py-1 border-b-4 border-socialBlue text-socialBlue font-bold";
        ...
        <div className="relative overflow-hidden rounded-md">
          ...
          <div className="p-4 pt-0 md:pt-4 pb-0">
            <div className="ml-24 md:ml-40">
              ...
              <div className="text-gray-500 leading-4">John Doe</div>
            </div>
